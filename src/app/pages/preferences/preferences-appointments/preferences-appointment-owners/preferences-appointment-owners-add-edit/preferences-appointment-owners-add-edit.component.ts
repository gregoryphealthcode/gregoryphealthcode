...
@Component({
  selector: 'app-preferences-appointment-owners-add-edit',
  templateUrl: './preferences-appointment-owners-add-edit.component.html',
  styleUrls: ['./preferences-appointment-owners-add-edit.component.scss']
})
export class PreferencesAppointmentOwnersAddEditComponent extends PopupReactiveFormBase implements OnInit {
  lluTitles: any[];
  ...
  protected getTitles() {
    return this.siteService.getTitlesForSite().subscribe(data => {
      this.titles = data;
