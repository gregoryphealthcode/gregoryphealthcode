...
import { FileModel, FileCheckResult, parseImageFile } from 'src/app/shared/helpers/file';
import { environment } from 'src/environments/environment';

@Component({
  selector: 'app-preferences-appointment-owners-photo-edit',
  templateUrl: './preferences-appointment-owners-photo-edit.component.html',
  styleUrls: ['./preferences-appointment-owners-photo-edit.component.scss']
})
export class PreferencesAppointmentOwnersPhotoEditComponent implements OnInit {
