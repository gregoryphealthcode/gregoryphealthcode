...
export class PreferencesAppointmentTypesComponent extends GridBase implements OnInit {
  ...
  showAppointmentTypePopup: boolean;
  selectedType: any;
  ...
  public addAppointmentTypeClicked() {
    this.selectedType = { id: 0 };
  }

  public editClicked(e) {
    this.selectedType = { id: e.data.appointmentTypeId };
  }

  public deleteAppointmentTypeClicked(e) {
  ...
  public closeAppointmentTypeClicked() {
    this._location.back();
  }
