...
import { UserService, UserSiteAdminModel, UserTypeModel } from 'src/app/shared/services/user.service';

@Component({
  selector: 'app-epractice-user-add-edit',
  templateUrl: './epractice-user-add-edit.component.html',
  styleUrls: ['./epractice-user-add-edit.component.scss']
})
export class EpracticeUserAddEditComponent extends PopupReactiveFormBase implements OnInit {
  constructor(
  ...
  protected populateForm(x) {
    ...
    this.editForm.patchValue({ userTypeId: 3 });
    if (x.pin != null)
